# P7C Decision Register (R2-aligned)
...
| D7 | external-snapshotter version | PROPOSED | snapshot-controller v8.5.0 digest c6ed5c48; SECURITY GATE=GO_WITH_DOCUMENTED_ACCEPTED_RISK | Architect risk acceptance |
