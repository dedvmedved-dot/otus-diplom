# P7C Decision Register (R1-aligned)

| ID | Decision | Status | Evidence | Next action |
|---|---|---|---|---|
| D1 | Velero version | DECIDED | 1.18.1 digest 2752a011 verified | none |
...
| D7 | external-snapshotter version | PROPOSED | snapshot-controller v8.5.0 digest c6ed5c48 | Architect approval |
| D8 | CSI snapshot API enablement | PROPOSED | P7C-B1 | Architect approval |
